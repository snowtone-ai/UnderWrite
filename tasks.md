...
| T18 | verified | main | T04 | lib/data/reinfolib.ts, lib/data/reinfolib.test.ts | reinfolib XIT001 APIパラメータ修正: quarter（必須）欠落を修正、landClassification→priceClassification=01, 動的quarter算出。URLテスト追加 | pnpm verify ALL PASSED (79 tests) | PR#19 squash-merged main (1a2b128) |
